...
<div id="container-17bdc3ff4d9e3bbe0f49799dd182c4c1"></div>
  ...
  <script>
    ...
    // Configuration: Enter your Cloudflare Worker URL here if hosting this HTML file separately.
    // If this HTML is served directly by the Worker, you can leave this empty.
    const CF_WORKER_URL = "";
    ...
    function getProxyUrl(targetUrl) {
      let workerUrl = CF_WORKER_URL;

      if (!workerUrl) {
        // If no worker URL configured, try to use current origin if on HTTP/HTTPS
